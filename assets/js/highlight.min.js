...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);/*! `cpp` grammar compiled for Highlight.js 11.3.1 */
...
const key_link = (result, key, link) => {
  const reg = new RegExp(`\\b${key}\\b`, "gm");
  result.value = result.value.replace(reg, `<a href="${link}">${key}</a>`);
}